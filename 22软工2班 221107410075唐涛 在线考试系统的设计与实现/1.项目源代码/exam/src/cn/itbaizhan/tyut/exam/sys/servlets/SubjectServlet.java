...
public class SubjectServlet extends HttpServlet {
	...
	/*** 修改试题功能* @param request* @param response*/
	...
	/*** 初始化修改页面* @param request* @param response* @throws IOException* @throws ServletException*/
	...
	/*** 查询试题列表* @param request* @param response* @throws IOException* @throws ServletException*/
	...
	/*** 增加试题功能* @param request* @param response*/
...
}//主要功能包括增加试题、查询试题列表、初始化修改页面和编辑试题。
