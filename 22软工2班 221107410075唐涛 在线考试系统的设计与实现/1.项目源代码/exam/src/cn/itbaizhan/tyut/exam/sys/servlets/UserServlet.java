...
public class UserServlet extends HttpServlet {
	...
	/*** 跳转首页* @param request* @param response*/
	...
	/*** 修改用户功能* @param request* @param response*/
	...
	/*** 用户初始化修改页面* @param request* @param response* @throws IOException* @throws ServletException* @throws IOException* @throws ServletException*/
	...
	/*** 修改用户密码功能* @param request* @param response*/
	...
	/*** 用户初始化密码修改页面* @param request* @param response* @throws IOException* @throws ServletException* @throws IOException* @throws ServletException*/
	...
	/*** 新增用户* @param request* @param response*/
	...
	/*** 获取用户列表* @param request* @param response* @throws IOException* @throws ServletException* @throws IOException* @throws ServletException*/
	...
	/*** 注销* @param request* @param response* @throws IOException*/
	...
	/*** 初始化主页* @param request* @param response*/
	...
	/*** 用户登陆* @param request* @param response* @throws IOException* @throws ServletException*/
	...
	/*** 学生获取试题内容* @param request* @param response* @throws IOException* @throws ServletException*/
...
//		String pname = new String(request.getParameter("pname").getBytes("iso-8859-1"), "utf-8");
	...
	/*** 提交回答问题* @param request* @param response* @throws UnsupportedEncodingException*/
...
//				request.getRequestDispatcher("/sys/user/add.jsp").forward(request, response);
	...
	/*** 学生登陆* @param request* @param response* @throws IOException* @throws ServletException*/
