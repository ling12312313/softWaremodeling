...
<body style="background-color:#f2f9fd;">
    <div class="header bg-main">
        <div class="logo margin-big-left fadein-top">
            <h1 style="color: black;"><img src="css/images/.jpg" class="radius-circle rotate-hover" height="50" alt="" />后台管理中心</h1>
        </div>
        <div class="head-l">
    ...
    <div class="leftnav">
        <div class="leftnav-title"><strong style="color: black;"><span class="icon-list"></span>菜单列表</strong></div>
